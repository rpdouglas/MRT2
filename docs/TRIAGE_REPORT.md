...
- [ ] **[BUG]** The notifications do not seem to be working
  - *Details:* `DEV` | Vault Unlocked: `true` | Reported: 4/13/2026
  - *ID:* `BWDrwRtyloiCxk6WAIbo`
- [ ] **[BUG]** Need a portal to be able to see user activity within the app like where they've been clicking how many insights they are running that sort of stuff. Not their actual data but the metrics around their usage of the app
  - *Details:* `DEV` | Vault Unlocked: `true` | Reported: 3/19/2026
  - *ID:* `AOA473i9F8X9CM3i5iHs`

### Phase 3: /insights Polish
- [ ] **[SUGGESTION]** And the insights page we should have an insights tab like we do in the journal that show some statistics about the insights that have been gathered
  - *Details:* `DEV` | Vault Unlocked: `true` | Reported: 3/17/2026
...
- **[SUGGESTION]** I like the idea of a gauge for self-care. Like how full is your cup? You know what I mean based on a few key items that would come into play if we can work on the healthconnect API
  - *Route:* `/journal` | Reported: 3/30/2026 | ID: `W1aaXpNNNvQXtGYRyQ0a`
- **[SUGGESTION]** Need to start bringing in data from Health, connect around steps and sleep and whenever other health related data I can get through that API
...
- **[BUG]** The Gemini API stats doesn't really tell me anything on the Apple TV and can we look at potentially bringing more and more data into that? That actually gives us some insight onto the usage of Gemini
  - *Route:* `/admin` | Reported: 3/19/2026 | ID: `9627hD68aENwYccd6dAl`
- **[SUGGESTION]** Need to create company letterhead and a slide deck master for a presentations
  - *Route:* `/profile` | Reported: 3/17/2026 | ID: `aPN0KJ1HYjVN8VBGNdcG`
- **[SUGGESTION]** It would be cool to have a 90 and 90 meeting tracker that you can do contest with friends, other users of my recovery toolkit and challenge them to a 90 and 90 challenge and other stuff like that
  - *Route:* `/dashboard` | Reported: 3/17/2026 | ID: `qj9u8xkD0Hs9OUKMQymc`
