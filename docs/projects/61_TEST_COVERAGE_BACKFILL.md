...
**Source:** `docs/reports/archive/2026-07_codebase_deep_review.md` §5. Precedent: `PROJ-40` (Core Logic Test Suite Audit) — same template, same "no new user-facing behavior" scope.
