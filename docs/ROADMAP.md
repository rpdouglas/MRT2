...
## 📅 Q1 2026: The Security & Foundation
*Focus: Hardening the Zero-Knowledge architecture and establishing CI/CD safety.*
...
*Focus: Deepening the AI capabilities and user retention.*

| Status | ID | Project Name | Owner | Impact |
| :--- | :--- | :--- | :--- | :--- |
| ⚪ Pending | `PROJ-04` | **Local RAG (Chat with Journal)** | Admin | "Talk to your past" |
| ⚪ Pending | `PROJ-05` | **Vitality 2.0 (Visuals)** | Admin | Photo Logging |
