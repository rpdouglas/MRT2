...
| 🟡 **In Progress** | `PROJ-67` | **Signing Key & Secrets Hygiene** | All | New keystore generated and stored in Google Secret Manager, `assetlinks.json` updated (2026-07-19). Still open: purge the old, compromised keystore from git history — held pending explicit confirmation. Blocks PROJ-07 Sprint 9.2. See `docs/projects/67_SIGNING_KEY_SECRETS_HYGIENE.md`. |
