 ...
 * GITHUB COMMENT:
 * [InsightsLog.tsx]
 * UPDATED: Added interactive "Add to Task" buttons for historical insights.
 * FIX: Enforced rule of 3 for display lists.
 */
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                            ...
                                            <ul className="space-y-2">
                                                {insight.suggested_actions?.slice(0, 3).map((action: string, i: number) => (
                                                    <li key={i} className="text-xs text-gray-700 flex items-center justify-between gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`p-1 rounded-full transition-all ${addedActions.has(action) ? 'text-green-500 bg-green-100' : 'text-gray-400 hover:text-purple-600 hover:bg-purple-100'}`}
                                                            title="Add to Quests"
                                                        >
