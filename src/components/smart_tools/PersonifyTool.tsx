    ...
    if (isEditing) {
        return (
            <div className="bg-white rounded-2xl shadow-lg border-2 border-purple-400 p-5 flex flex-col gap-4 animate-in fade-in zoom-in-95 duration-200">
                <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Rogue's Name</label>
                    <input 
                        type="text" 
                        value={editName} 
                ...
                <div>
                    <label className="block text-xs font-bold text-rose-500 uppercase tracking-wider mb-1">The Lie It Tells</label>
                    <textarea 
                        rows={2}
                        value={editAction} 
                ...
                <div>
                    <label className="block text-xs font-bold text-emerald-500 uppercase tracking-wider mb-1">The Truth (Disarm)</label>
                    <textarea 
                        rows={2}
                        value={editResult} 
                        ...
                        {isAdding && (
                            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border-2 border-purple-200 animate-in fade-in slide-in-from-top-4 duration-300">
                                ...
                                <div className="space-y-5">
                                    <div>
                                        <label className="block text-sm font-bold text-gray-700 mb-1">Rogue's Name</label>
                                        <input 
                                            type="text" 
                                            value={newName} 
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        <div>
                                            <label className="block text-sm font-bold text-rose-600 mb-1">The Lie It Tells</label>
                                            <textarea 
                                                rows={3}
                                                value={newAction} 
                                        ...
                                        <div>
                                            <label className="block text-sm font-bold text-emerald-600 mb-1">The Truth (Disarm)</label>
                                            <textarea 
                                                rows={3}
                                                value={newResult} 
