...
**If you installed MRT from the Google Play Store:** you can subscribe directly inside the app with a single tap using native Google Play Billing. If you are already a Supporter through Google Play, tapping **"Manage Subscription"** takes you directly to the Google Play Store subscription management page.
